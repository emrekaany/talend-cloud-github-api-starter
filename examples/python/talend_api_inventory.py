...
from talend_api_starter.workflows import save_talend_inventory
...
def main() -> int:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("talend-output"))
    args = parser.parse_args()
    with TalendApiClient.from_env() as client:
